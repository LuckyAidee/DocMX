...
export default function CategoryHeroRFC({ title, subtitle }) {
  return (
    <div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 w-full items-center">
          ...
          <div className="relative flex items-center justify-center lg:justify-start order-2 lg:order-1">
            ...
            <div className="relative w-96 h-64 lg:w-[480px] lg:h-[320px]">
              ...
              <div className="absolute inset-0 bg-gradient-radial from-slate-400/20 via-slate-500/10 to-transparent blur-3xl scale-90 group-hover:scale-110 group-hover:from-slate-400/25 transition-all duration-700" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              
              {/* Glow exterior secundario */}
              <div className="absolute inset-0 bg-gradient-to-br from-slate-400/15 to-gray-500/15 blur-2xl scale-95 group-hover:scale-105 opacity-70 group-hover:opacity-90 transition-all duration-700" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              
              {/* Tarjeta principal horizontal con gradiente - TRAPEZOIDE */}
              <div className="absolute inset-0 bg-gradient-to-br from-slate-500/20 via-slate-600/15 to-gray-500/10 border border-slate-400/30 group-hover:border-slate-400/50 backdrop-blur-sm transition-all duration-700 shadow-xl shadow-slate-500/10" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              
              {/* Marcos concéntricos rectangulares para profundidad - AHORA TRAPEZOIDES */}
              <div className="absolute inset-6 border border-slate-400/15 opacity-60 group-hover:opacity-100 transition-opacity duration-700" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              <div className="absolute inset-12 border border-slate-400/10 opacity-40 group-hover:opacity-70 transition-opacity duration-700" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              <div className="absolute inset-16 border border-slate-400/5 opacity-30 group-hover:opacity-50 transition-opacity duration-700" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              
              {/* Vignette interno */}
              <div className="absolute inset-0 bg-gradient-to-br from-transparent via-transparent to-slate-900/20" style={{clipPath: 'polygon(15% 0%, 85% 0%, 100% 100%, 0% 100%)'}}></div>
              ...
              <div className="absolute inset-0 flex items-center justify-center" style={{perspective: '1000px'}}>
                ...
                <div className="absolute transform -rotate-6 translate-x-6 translate-y-6 opacity-20 group-hover:opacity-30 group-hover:translate-x-8 group-hover:translate-y-8 transition-all duration-700">
                  ...
                  >
                    ...
                    <polygon points="0,0 200,0 170,60 30,60" fill="#6b7280"/>
                  </svg>
                </div>
                ...
                <div className="absolute transform -rotate-4 translate-x-3 translate-y-3 opacity-40 group-hover:opacity-50 group-hover:translate-x-5 group-hover:translate-y-5 transition-all duration-700">
                  ...
                  >
                    ...
                    <polygon points="0,0 200,0 170,60 30,60" fill="#9ca3af"/>
                  </svg>
                </div>
                ...
                <div className="relative transform -rotate-3 group-hover:-rotate-1 group-hover:scale-105 group-hover:-translate-y-3 transition-all duration-700" style={{transformStyle: 'preserve-3d'}}>
                  ...
                  >
                    ...
                    <rect width="200" height="260" fill="url(#innerShadowRFC)" rx="4"/>
                    
                    {/* Header TRAPEZOIDE con gradiente */}
                    <defs>
                      <linearGradient id="headerGradientRFC" x1="0%" y1="0%" x2="100%" y2="0%">
                        <stop offset="0%" style={{stopColor: '#475569', stopOpacity: 1}} />
                        <stop offset="100%" style={{stopColor: '#334155', stopOpacity: 1}} />
                      </linearGradient>
                      <linearGradient id="innerShadowRFC" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" style={{stopColor: '#000000', stopOpacity: 0.02}} />
                        <stop offset="100%" style={{stopColor: '#000000', stopOpacity: 0}} />
                      </linearGradient>
                    </defs>
                    
                    {/* TRAPEZOIDE en lugar de rectángulo - ángulos más pronunciados */}
                    <polygon points="0,0 200,0 170,60 30,60" fill="url(#headerGradientRFC)"/>
                    
                    <text x="100" y="25" textAnchor="middle" fill="white" fontSize="16" fontWeight="bold" letterSpacing="2">RFC</text>
                    <text x="100" y="45" textAnchor="middle" fill="white" fontSize="12" fontWeight="600" letterSpacing="1.2">CONTRIBUYENTE</text>
                    
                    {/* Escudo SAT con más detalle */}
                    ...
                    <text x="100" y="103" textAnchor="middle" fill="#2d3748" fontSize="9" fontWeight="bold" opacity="0.6">SAT</text>
                    <text x="100" y="113" textAnchor="middle" fill="#2d3748" fontSize="6" fontWeight="600" opacity="0.4">MÉXICO</text>
                    ...
                    {/* Firma elegante */}
                    <path d="M 50 248 Q 70 243, 90 248" stroke="#475569" strokeWidth="2" fill="none" opacity="0.3"/>
                    <rect x="45" y="251" width="50" height="0.5" fill="#475569" opacity="0.4"/>
                  </svg>
          ...
          <div className="space-y-7 z-10 order-1 lg:order-2">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-slate-500/8 backdrop-blur-sm rounded-lg border border-slate-500/20">
              ...
              <span className="text-slate-300 text-sm font-medium">Documentos Fiscales</span>
            </div>
            ...
            <div className="pt-2">
              <div className="inline-flex items-center gap-2 text-slate-400/80 text-sm">
                ...
                <span className="font-medium">Trámite SAT oficial</span>
              </div>
            </div>
          </div>
