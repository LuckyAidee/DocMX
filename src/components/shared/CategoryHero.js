    ...
    >
      ...
      <div className="relative h-full container mx-auto px-8 lg:px-20 flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 w-full items-center">
          ...
          {/* IZQUIERDA - TARJETA HORIZONTAL (Forma Original, Color RFC) */}
          <div className="relative flex items-center justify-center lg:justify-start order-2 lg:order-1">
            ...
            <div className="relative w-96 h-64 lg:w-[480px] lg:h-[320px]">
              ...
              <div className="absolute inset-0 rounded-3xl bg-gradient-radial from-slate-400/30 via-slate-500/15 to-transparent blur-3xl scale-90 group-hover:scale-110 group-hover:from-slate-400/40 transition-all duration-700"></div>
              
              {/* Glow exterior secundario (Paleta RFC) */}
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-slate-400/20 to-gray-500/20 blur-2xl scale-95 group-hover:scale-105 opacity-70 group-hover:opacity-90 transition-all duration-700"></div>
              
              {/* Tarjeta principal (Paleta RFC) */}
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-slate-500/25 via-slate-600/20 to-gray-500/15 border border-slate-400/40 group-hover:border-slate-400/60 backdrop-blur-sm transition-all duration-700 shadow-xl shadow-slate-500/10"></div>
              
              {/* Marcos concéntricos (Paleta RFC) */}
              <div className="absolute inset-6 rounded-2xl border border-slate-400/15 opacity-60 group-hover:opacity-100 transition-opacity duration-700"></div>
              <div className="absolute inset-12 rounded-xl border border-slate-400/10 opacity-40 group-hover:opacity-70 transition-opacity duration-700"></div>
              <div className="absolute inset-16 rounded-lg border border-slate-400/5 opacity-30 group-hover:opacity-50 transition-opacity duration-700"></div>
              ...
              <div className="absolute inset-0 flex items-center justify-center" style={{perspective: '1000px'}}>
                ...
                {/* Documento principal (SVG Original, Color RFC) */}
          ...
          <div className="space-y-7 z-10 order-1 lg:order-2">
            ...
            <div className="inline-flex items-center gap-2.5 px-4 py-2 bg-slate-500/8 backdrop-blur-sm rounded-lg border border-slate-500/20">
              ...
              <span className="text-slate-300 text-sm font-medium">Documentos Certificados</span>
            </div>
